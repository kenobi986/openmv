...
while True:
    ...
    # Save the 14-bit data as a binary file
    with open("/t14_image.bin", "wb") as bin_file:
        for value in t_14:
            bin_file.write(value.to_bytes(2, 'little'))  # Write 14-bit values as 2-byte little-endian
